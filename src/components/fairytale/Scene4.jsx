...
function Scene4({ s4 }) {
    ...
    return (
        <motion.div className={"millerScene"} style={{opacity: s4.sceneFade, top: "0"}}>
            ...
            <motion.div className={"parallax-lock"}>
                ...
                >
                    <span>But no...</span>
                    <br/>
                    <motion.span style={{opacity: s4.txtOpacity2}}>He LOVED boasting about things.</motion.span>
                    <br/>
                    <motion.span style={{opacity: s4.txtOpacity3}}>EVEN if those things weren't always true.</motion.span>
                    <br/>
                    <motion.span style={{opacity: s4.txtOpacity4}}>Like about his daughter for example.</motion.span>
                </motion.p>
                ...
                <motion.p className={"txt parallax-lock"} style={{...center, top: "85vh"}}>
                    <motion.span style={{opacity: s4.txtOpacity5}}>He would tell everyone who wanted to hear how his
                        daughter could turn straw into gold by spinning it.
                    </motion.span>
                    <br/>
                    <motion.span style={{opacity: s4.txtOpacity6}}>And everyone who didn't want to hear it, but
