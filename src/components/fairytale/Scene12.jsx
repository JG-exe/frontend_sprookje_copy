    ...
    return (
        <>
            <m.div className={"parallax-lock"} style={{opacity: s.sceneFade, zIndex: 2, pointerEvents: "none"}}>
                ...
                <m.span style={{opacity: s.txtOpacity3, top: "30vh", left: "20vw", rotate: "10deg", x: s.moveTxtNeg}} className={"parallax-lock txt"}>
                    Today I'll bake
                </m.span>
                <m.span style={{opacity: s.txtOpacity4, top: "28vh", left: "26vw", rotate: "-10deg", y: s.moveTxtNeg}} className={"parallax-lock txt"}>
                    tomorrow I'll brew,
                </m.span>
                <m.span style={{opacity: s.txtOpacity5, top: "34vh", left: "32vw", rotate: "7deg", x: s.moveTxtPos}} className={"parallax-lock txt"}>
                    Then I'll fetch the queen's new child,
                </m.span>
                <m.span style={{opacity: s.txtOpacity6, top: "30vh", left: "56vw", rotate: "-12deg", y: s.moveTxtPos}} className={"parallax-lock txt"}>
                    It is good that no one knows,
                </m.span>
                <m.span style={{opacity: s.txtOpacity7, top: "36vh", left: "63vw", rotate: "15deg", y: s.moveTxtNeg }} className={"parallax-lock txt"}>
