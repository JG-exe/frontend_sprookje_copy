...
function Scene5({s5}) {
    ...
    return (
        <motion.div className={"parallax-lock"} style={{opacity: s5.sceneFade}}>
            ...
            <motion.p className={"txt parallax-lock"} style={{...center, top: "90vh", opacity: s5.txtOpacity1}}>
                <motion.span>
            ...
            <motion.p className={"txt parallax-lock"} style={{...center, top: "90vh", opacity: s5.txtOpacity2}}>
